        ...
        <div className="flex flex-col gap-6">
          <RoughNotationGroup show={true}>
            ...
            <span className=" text-l text-neutral-400 leading-7">
              ...
              from Tunisia, with a Bachelor Degree in Computer Science Applied
              to E-Business. I turn modern tech into digital magic, crafting
              sleek and snappy web experiences with a trusty toolkit that
              includes:
            </span>
